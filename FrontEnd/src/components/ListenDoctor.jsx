...
const SpeechToTextComponent = () => {
    ...
    return (
        <div className="min-h-screen flex items-center justify-center bg-cover bg-center" style={{ backgroundImage: `url('/Default_a_hospital_environment_for_a_website_background_2.jpg')` }}>
            <div className="container mx-auto px-4 py-8 max-w-md">
                <div className="flex flex-col items-center mb-4">
                    <button className="p-2 rounded-full bg-blue-500 text-white mb-4" onClick={handleMicrophoneClick} disabled={listening}>
                        <FaMicrophone />
                    </button>
                    <textarea
